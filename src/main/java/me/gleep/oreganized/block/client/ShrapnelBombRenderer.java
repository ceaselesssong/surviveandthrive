package me.gleep.oreganized.block.client;
...
@OnlyIn(Dist.CLIENT)
public class ShrapnelBombRenderer extends EntityRenderer<PrimedTnt> {
    public ShrapnelBombRenderer(EntityRendererProvider.Context p_174426_) {
        super(p_174426_);
